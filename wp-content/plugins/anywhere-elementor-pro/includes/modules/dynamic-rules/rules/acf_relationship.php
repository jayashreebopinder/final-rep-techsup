...
class Acf_Relationship extends RuleBase {
	...
	// public function check(  $operator, $value, $name=null, $parent=null) {

	// 	global $post;
	// 	if(is_array($name)){
	// 		$parent_field = $name['parent_field'];
	// 		if(Frontend::$_in_repeater_block == false){
				
	// 			$field_data = explode(':', $parent_field);
	...
	// 				$data = $post->ID;
	// 			}
	// 			$field_args['field_name'] = $name['sub_field'];
	// 			$field_args['parent_field'] = $name['parent_field'];
	// 			$field_value = AcfMaster::instance()->get_repeater_field_data( $name['sub_field'], $parent_field, $data );
	// 		}else{
	...
	public function check(  $operator, $value, $name=null) {	
		...
		switch($parent){
			case 'repeater':	if(empty($name['parent_type']) || empty($name['sub_field'])){
									return;
								}
								...
								break;
			case 'group':		if(empty($name['parent_type']) || empty($name['sub_field'])){
									return;
								}
